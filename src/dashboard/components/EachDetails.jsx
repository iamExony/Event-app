...
const EachDetails = ({ type, data, options, isOpen, onOpen }) => {
  const { id: prospect_id, date, client, source, location, status } = data;
  const { name } = client;
        ...
        <div className="flex w-full items-center justify-between mr-[4px]">
          ...
          <div className="relative mx-4">
            ...
            <div className="absolute w-max top-[100%] right-[10px] bg-White rounded-md py-3 shadow-md z-10">
              <ul>
                {options(prospect_id).map((option, index) => (
