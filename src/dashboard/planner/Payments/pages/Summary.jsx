...
function Summary({ specifications,  setComplete,
    setCurrentStep,
    setIsOpen, }) {
  ...
  return (
    <>
      ...
      <div
        className="absolute top-[500px] right-[180px] z-10 rounded-full border border-formColor flex justify-center items-center  shadow-md shadow-formColor cursor-pointer w-8 h-8"
        onClick={() => swiperElRef.current.swiper.slideNext()}
      >
        <BsChevronRight />
      </div>
      <div
        className="absolute top-[500px] left-[180px] z-10 rounded-full border border-formColor flex justify-center items-center  shadow-md shadow-formColor cursor-pointer w-8 h-8"
      ...
      <div className="flex flex-col gap-8 md:absolute top-[218px] mt-4 md:mt-0 right-12 md:w-[170px] z-10">
        ...
        <PrevButton onClick={() => {}} className={"w-[150px]"}>
          Download
        </PrevButton>
        <PrevButton
          onClick={() => {
