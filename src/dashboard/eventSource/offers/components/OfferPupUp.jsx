...
function OfferPupUp({ setIsOpen }) {
  ...
  const offerLink = "e-vent.offer/client-offer";
  ...
  return (
    <>
      ...
      <div className="w-[647px] h-[331px] border-2 border-borderColor p-6 pr-12 absolute left-[50%] -translate-x-[50%] top-[277px] z-10 bg-white">
        <div className="flex justify-start items-start gap-12 mb-6 ">
          <h5
            className={
              type === "copy"
        ...
        <div className="flex items-center justify-center gap-1 bg-primaryColC text-white p-3 rounded-md mt-4">
          <span>
            <PiWarningOctagonBold size={25} />
          </span>
          Viewers of this offer link would have access to limited information
        </div>
