...
export default function DropdownButton({ type, addNew, viewAll }) {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        <MenuItem
          onClick={handleClose.bind(null, `/marketplace/edit-webpage`)}
          disableRipple
          sx={{
            fontWeight: "500",
            display: "flex",
        ...
        <MenuItem
          onClick={handleClose.bind(null, `/marketplace/e-sales`)}
          disableRipple
